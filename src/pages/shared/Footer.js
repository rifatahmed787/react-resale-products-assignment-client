...
const Footer = () => {
  return (
    <div className="mt-16 bg-[#005C5A] text-[#FFC745] border-t-2 border-[#149777]  divide-gray-800 dark:bg-[#2C3F46] dark:text-gray-100 mb-0">
        ...
        <div>
          ...
          <div className="form-control lg:w-80 md:w-80 input-width">
            ...
            <div className="relative">
              ...
              />
              <button className="btn text-[#FFC745] dark:text-white bg-[#005C5A] hover:bg-[#005C5A] absolute top-0 right-0 rounded-l-none">
                Subscribe
              </button>
            </div>
          </div>
      ...
      <div className="">
        <div className="text-sm text-center mx-auto dark:text-gray-300">
          <p className="pb-3">
