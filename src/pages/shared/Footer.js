...
const Footer = () => {
  return (
    <div className="mt-32 ">
      <footer className="px-4 border-t-2 mt-0 border-[#149777] divide-y divide-gray-800 dark:bg-gray-800 dark:text-gray-100 mb-0 ">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div className="lg:w-1/3">
            ...
            <p className="px-5 lg:pr-10">
              A second hand laptop online shop. The best shop for second hand
